            ...
            <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10">
              <div className="bg-white p-8 rounded-xl shadow">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Our mission is to make financial support accessible to
                  everyone through simple, fast, and trustworthy loan services
              ...
              <div className="bg-white p-8 rounded-xl shadow">
                ...
                <p className="text-slate-600 leading-relaxed">
                  We envision a future where no one is limited by lack of
                  financial access, empowering communities through responsible
                  lending.
                </p>
              </div>
            </div>
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
                <div className="p-6 border rounded-xl hover:shadow transition">
                  ...
                  <p className="text-slate-600">
                    Get loan approval within minutes with a smooth digital
                    process.
                  </p>
                </div>
                ...
                <div className="p-6 border rounded-xl hover:shadow transition">
                  ...
                  <p className="text-slate-600">
                    Your data and transactions are protected with modern
                    security.
                  </p>
                </div>
